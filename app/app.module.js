...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [events_app_component_1.EventsAppComponent, events_list_component_1.EventsListComponent, events_thumbnail_component_1.EventsThumbnailComponent, navbar_component_1.NavBarComponent, event_details_component_1.EventDetailComponent, create_event_component_1.CreateEventComponent, _404_component_1.Error404Component],
            providers: [event_service_1.EventService, toastr_service_1.ToastrServices, event_route_activator_service_1.EventRouteActivator],
            bootstrap: [events_app_component_1.EventsAppComponent] // A process of telling angular where do i start -- STARTING PLACE
        }), 
